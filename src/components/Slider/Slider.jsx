...
export const Slider = ({ categoryList, categoryEdit, handleActive }) => {
  ...
  const pathSettings = {
    ...
    sliderShowArrow: location.pathname === "/category" ? categoryList.length > 7 : categoryList.length > 5,
    ...
    sliderSlide: location.pathname === "/category" ? {left: `${slide}px`, right: `${categoryList.length < 7 ? 0 : "auto"}`} : {top: `${slide}px`},
  ...
  return (
    <div className={pathSettings.sliderWrapper}>
      { pathSettings.sliderShowArrow &&
        <button
          type="button"
          ...
          disabled={step === 0}
        >
          <svg style={pathSettings.sliderArrow} width="50" height="30" viewBox="0 0 50 30" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className={pathSettings.sliderHidden}>
        <div className={pathSettings.sliderLine} style={pathSettings.sliderSlide}>
      ...
      { pathSettings.sliderShowArrow &&
        <button
          ...
          disabled={pathSettings.sliderStep}
        >
          <svg style={pathSettings.sliderArrow} width="50" height="30" viewBox="0 0 50 30" fill="none" xmlns="http://www.w3.org/2000/svg">
