...
export const Slider = ({ idx, wrapper, sliderIconWrapper, leftArrow, rightArrow, sliderLine, categoryList, categoryEdit, handleActive }) => {
  ...
  return (
    <div className={wrapper}>
      { categoryList?.length > idx &&
        <button type="button" className={styles.sliderArrow} onClick={handleUp} disabled={step === 0}>
          <svg className={leftArrow} width="50" height="30" viewBox="0 0 50 30" fill="none" xmlns="http://www.w3.org/2000/svg">
